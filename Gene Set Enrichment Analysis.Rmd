...
kegg_plot<- ggplot(top20_kegg, aes(x = size, y = reorder(pathway, -NES), fill = padj)) +
...
# Plot the 'size' column from the table onto x-axis, the the top 20 pathways on the y-axis
# Using the size because size represents the size of each pathway after removing genes not present in 'names(stats)'
reactome_plot<- ggplot(top20_reactome, aes(x = size, y = reorder(pathway, -NES), fill = padj)) +
  geom_bar(stat = "identity") +
  xlab("number of genes") +
  ylab("pathway") +  
  scale_fill_gradient(low = "gray70", high = "red") +
...
# Plot the 'size' column from the table onto x-axis, the the top 20 pathways on the y-axis
# Using the size because size represents the size of each pathway after removing genes not present in 'names(stats)'
go_barplot<-ggplot(top20_GO, aes(x = size, y = reorder(pathway, -NES), fill = padj)) +
  geom_bar(stat = "identity") +
  xlab("number of genes") +
  ylab("pathway") +  
  scale_fill_gradient(low = "gray70", high = "red") +

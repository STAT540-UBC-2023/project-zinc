...
There are 10 significant pathways.
...
# gene_sets <- read.gmt("path/to/gene/set/file.gmt")
result <- enricher(gene = gene_id, TERM2GENE = DEgenes)
emap <- emapplot(result, cutoff = 0.05, nodeSize = 3, edgeSize = 0.2, n = 3)
...
gene_values
data(gene_values)
de <- names(DEgenes)[abs(DEgenes) > 2]

...
### View T2D Overall Pathway with `enrichKEGG` Function
...
kegg_enrich <- enrichKEGG(gene = filtered_genes$entrezgene_id,
                 organism     = 'human',
                 pvalueCutoff = 0.05)

# visualize the enriched pathway - find the pathway of interests
...
# category netplot
cnetplot(kk2, categorySize="pvalue", foldChange=gene_list, cex_label_category = 0.5)

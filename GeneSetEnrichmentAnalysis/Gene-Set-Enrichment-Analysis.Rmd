...
# export result as csv
write.csv(kegg_significant_pathways, "kegg_significant_pathways.csv", row.names=FALSE)
```
...
# export result as csv
write.csv(pid_significant_pathways, "pid_significant_pathways.csv", row.names=FALSE)
```
...
# export result as csv
write.csv(reactome_significant_pathways, "reactome_significant_pathways.csv", row.names=FALSE)
```
...
# export result as csv
write.csv(IMMUNE_significant_pathways, "IMMUNE_significant_pathways.csv", row.names=FALSE)
```

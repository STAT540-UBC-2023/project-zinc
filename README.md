...
------------|----------|---------|----------
Cindy (Xiao Yu) Zhang|Bioinformatics|MSc.(Bioinformatics), PharmD| datasets selection, wrangling, EDA, batch effect visualization, regression model building and results interpretation

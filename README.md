...
Janet (Jia He) Zhang |Pharmacology|BSc.(Pharmacology)|Gene set enrichment analysis, Github management, and GSEA result intepretation
Lucy Chi|Biochemistry|BSc. Honour(Biochemistry & Molecular Biology)| Data reformatting for GSEA, Gene set enrichment analysis, diseases associated with T2D, and GSEA result interpretation

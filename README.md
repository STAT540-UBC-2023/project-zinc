...
------------|----------|---------|----------
Cindy (Xiao Yu) Zhang|Bioinformatics|BSc.(Pharm), PharmD, RPh| Literature review, datasets selection, data wrangling, SVD visualization, linear regression and results interpretation

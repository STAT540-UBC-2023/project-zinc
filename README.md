...
## Table of Content: 
1. [Gene Set Enrichment Analysis Folder: contains everything](https://github.com/STAT540-UBC-2023/project-zinc/tree/main/GeneSetEnrichmentAnalysis) (e.g., .Rmd file, .md file, results and plots) generated for the gene set enrichment analysis. 
